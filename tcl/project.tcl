...
# Change clock frequency and activate PL -> PS interrupt port (not required)
startgroup
...
startgroup
# The _0 postfix is used as running number of IP core instances of the same type
...
# Connect external ports of IP core (only interrupt port in this case)
